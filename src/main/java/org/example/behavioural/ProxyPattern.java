...
class ProxyInternetAccess implements OfficeInternetAccess {
    ...
    public int getRole(String emplName) {
        if(emplName.contentEquals("Nishant"))
            return 5;
        else
            return 0;
    }
...
public class ProxyPattern {
    public ProxyPattern()
    {
        OfficeInternetAccess access = new ProxyInternetAccess("Nishant");
        OfficeInternetAccess access2 = new ProxyInternetAccess("EMPLOYEE22");
        access.grantAccess();
        access2.grantAccess();
    }
}